from aorist import aorist, UploadStaticDataToBigQuery
...
def recipe(project_name, dataset_location, service_account_file, dataset_name, table_name, tmp_dir, source_file, columns, source_is_json):
