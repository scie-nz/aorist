...
primary_schema! {
    ...
    attributes:
      ...
      id: Int64Identifier("TBD, is distinct within a given event_timestamp but not across timestamps", false), // TODO unsure if nullable, TODO max value is 8M - smaller int type?
      ...
      titles: FreeText("Zero or more titles (in LINZPropertyTitlesSchema) this parcel is associated with", true), // TODO declare as nullable array of strings
