...
primary_schema! {
    ...
    attributes:
      ...
      id: Int64Identifier("TBD, is distinct within a given event_timestamp but not across timestamps", false), // TODO unsure if nullable, TODO max value is 4M - smaller int type?
      ...
      issue_date: ISO8601Timestamp("When the title was issued", false), // TODO unsure if nullable
      ...
      owners: FreeText("Owner full names, In PII dataset (50805) only", true), // TODO declare as nullable array of strings
