...
""",
    ...
    "ca_HepTh": {
        "dep_list": [],
        "command": hive_schemas_created_command.format(
            table_name="ca_HepTh", data_format="ORC", schema=hive_schemas_created_schema
        ),
    },
    "amazon0312": {
        "dep_list": [],
    ...
    "ca_HepPh": {
        "dep_list": [],
        "command": hive_schemas_created_command.format(
            table_name="ca_HepPh", data_format="ORC", schema=hive_schemas_created_schema
        ),
    },
    "web_NotreDame": {
        "dep_list": [],
    ...
    "ca_GrQc": {
        "dep_list": [],
        "command": hive_schemas_created_command.format(
            table_name="ca_GrQc", data_format="ORC", schema=hive_schemas_created_schema
        ),
    },
}
