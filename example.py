...
params_hive_schemas_created = {
    "amazon0601": {
        "dep_list": [],
        "command": hive_schemas_created_command.format(
            data_format="ORC",
    ...
    "ca_HepTh": {
        "dep_list": [],
        "command": hive_schemas_created_command.format(
            data_format="ORC", table_name="ca_HepTh", schema=hive_schemas_created_schema
        ),
    },
    "ca_CondMat": {
        "dep_list": [],
    ...
    "ca_HepPh": {
        "dep_list": [],
        "command": hive_schemas_created_command.format(
            data_format="ORC", table_name="ca_HepPh", schema=hive_schemas_created_schema
        ),
    },
    "ca_GrQc": {
        "dep_list": [],
        "command": hive_schemas_created_command.format(
            data_format="ORC", table_name="ca_GrQc", schema=hive_schemas_created_schema
        ),
    },
    "web_Stanford": {
        "dep_list": [],
...
for (t, params) in params_hive_schemas_created.items():
    tasks_hive_schemas_created[t] = ShellTask(
        command=params_hive_schemas_created["command"]
    )
...
params_download_data_from_remote_web_location = {
    "web_Stanford": {
        "dep_list": [],
        "command": "curl {address} -O {tmp_dir}/{file_name}".format(
...
for (t, params) in params_download_data_from_remote_web_location.items():
    tasks_download_data_from_remote_web_location[t] = ShellTask(
        command=params_download_data_from_remote_web_location["command"]
    )
...
params_decompress = {
    "amazon0302": {
        "dep_list": [tasks_download_data_from_remote_web_location["amazon0302"]],
        "command": "gunzip {tmp_dir}/{file_name}".format(
            file_name="amazon0302", tmp_dir="/tmp/snap/amazon0302/"
        ),
    },
    "ca_AstroPh": {
        "dep_list": [tasks_download_data_from_remote_web_location["ca_AstroPh"]],
        "command": "gunzip {tmp_dir}/{file_name}".format(
            file_name="ca_AstroPh", tmp_dir="/tmp/snap/ca_AstroPh/"
        ),
    },
    "amazon0312": {
        "dep_list": [tasks_download_data_from_remote_web_location["amazon0312"]],
        "command": "gunzip {tmp_dir}/{file_name}".format(
            file_name="amazon0312", tmp_dir="/tmp/snap/amazon0312/"
        ),
    },
    "ca_HepPh": {
        "dep_list": [tasks_download_data_from_remote_web_location["ca_HepPh"]],
        "command": "gunzip {tmp_dir}/{file_name}".format(
            file_name="ca_HepPh", tmp_dir="/tmp/snap/ca_HepPh/"
        ),
    },
    "ca_HepTh": {
        "dep_list": [tasks_download_data_from_remote_web_location["ca_HepTh"]],
        "command": "gunzip {tmp_dir}/{file_name}".format(
            file_name="ca_HepTh", tmp_dir="/tmp/snap/ca_HepTh/"
        ),
    },
    "web_Google": {
        "dep_list": [tasks_download_data_from_remote_web_location["web_Google"]],
        "command": "gunzip {tmp_dir}/{file_name}".format(
            file_name="web_Google", tmp_dir="/tmp/snap/web_Google/"
        ),
    },
    "ca_GrQc": {
        "dep_list": [tasks_download_data_from_remote_web_location["ca_GrQc"]],
        "command": "gunzip {tmp_dir}/{file_name}".format(
            file_name="ca_GrQc", tmp_dir="/tmp/snap/ca_GrQc/"
        ),
    },
    "web_NotreDame": {
        "dep_list": [tasks_download_data_from_remote_web_location["web_NotreDame"]],
        "command": "gunzip {tmp_dir}/{file_name}".format(
            file_name="web_NotreDame", tmp_dir="/tmp/snap/web_NotreDame/"
        ),
    },
    "amazon0505": {
        "dep_list": [tasks_download_data_from_remote_web_location["amazon0505"]],
        "command": "gunzip {tmp_dir}/{file_name}".format(
            file_name="amazon0505", tmp_dir="/tmp/snap/amazon0505/"
        ),
    },
    "amazon0601": {
        "dep_list": [tasks_download_data_from_remote_web_location["amazon0601"]],
        "command": "gunzip {tmp_dir}/{file_name}".format(
            file_name="amazon0601", tmp_dir="/tmp/snap/amazon0601/"
        ),
    },
    "ca_CondMat": {
        "dep_list": [tasks_download_data_from_remote_web_location["ca_CondMat"]],
        "command": "gunzip {tmp_dir}/{file_name}".format(
            file_name="ca_CondMat", tmp_dir="/tmp/snap/ca_CondMat/"
        ),
    },
    "sentinel": {
        "dep_list": [download_data_from_remote_gcs_location__sentinel_location],
        "command": "gunzip {tmp_dir}/{file_name}".format(
            file_name="sentinel-2-metadata-table", tmp_dir="/tmp/sentinel2"
        ),
    },
    "web_Stanford": {
        "dep_list": [tasks_download_data_from_remote_web_location["web_Stanford"]],
        "command": "gunzip {tmp_dir}/{file_name}".format(
            file_name="web_Stanford", tmp_dir="/tmp/snap/web_Stanford/"
        ),
    },
    "web_BerkStan": {
        "dep_list": [tasks_download_data_from_remote_web_location["web_BerkStan"]],
        "command": "gunzip {tmp_dir}/{file_name}".format(
            file_name="web_BerkStan", tmp_dir="/tmp/snap/web_BerkStan/"
        ),
    },
}
...
params_remove_file_header = {
    "ca_HepTh": {
        "dep_list": [tasks_decompress["ca_HepTh"]],
        "command": remove_file_header_command.format(
            n="2", tmp_dir="/tmp/snap/ca_HepTh/", file_name="ca_HepTh"
        ),
    },
    "amazon0601": {
        "dep_list": [tasks_decompress["amazon0601"]],
        "command": remove_file_header_command.format(
            n="2", tmp_dir="/tmp/snap/amazon0601/", file_name="amazon0601"
        ),
    },
    "amazon0505": {
        "dep_list": [tasks_decompress["amazon0505"]],
        "command": remove_file_header_command.format(
            n="2", tmp_dir="/tmp/snap/amazon0505/", file_name="amazon0505"
        ),
    },
    "amazon0302": {
        "dep_list": [tasks_decompress["amazon0302"]],
        "command": remove_file_header_command.format(
            n="2", tmp_dir="/tmp/snap/amazon0302/", file_name="amazon0302"
        ),
    },
    "web_BerkStan": {
        "dep_list": [tasks_decompress["web_BerkStan"]],
        "command": remove_file_header_command.format(
            n="2", tmp_dir="/tmp/snap/web_BerkStan/", file_name="web_BerkStan"
        ),
    },
    "web_Google": {
        "dep_list": [tasks_decompress["web_Google"]],
        "command": remove_file_header_command.format(
            n="2", tmp_dir="/tmp/snap/web_Google/", file_name="web_Google"
        ),
    },
    "ca_GrQc": {
        "dep_list": [tasks_decompress["ca_GrQc"]],
        "command": remove_file_header_command.format(
            n="2", tmp_dir="/tmp/snap/ca_GrQc/", file_name="ca_GrQc"
        ),
    },
    "web_Stanford": {
        "dep_list": [tasks_decompress["web_Stanford"]],
        "command": remove_file_header_command.format(
            n="2", tmp_dir="/tmp/snap/web_Stanford/", file_name="web_Stanford"
        ),
    },
    "web_NotreDame": {
        "dep_list": [tasks_decompress["web_NotreDame"]],
        "command": remove_file_header_command.format(
            n="2", tmp_dir="/tmp/snap/web_NotreDame/", file_name="web_NotreDame"
        ),
    },
    "ca_CondMat": {
        "dep_list": [tasks_decompress["ca_CondMat"]],
        "command": remove_file_header_command.format(
            n="2", tmp_dir="/tmp/snap/ca_CondMat/", file_name="ca_CondMat"
        ),
    },
    "ca_HepPh": {
        "dep_list": [tasks_decompress["ca_HepPh"]],
        "command": remove_file_header_command.format(
            n="2", tmp_dir="/tmp/snap/ca_HepPh/", file_name="ca_HepPh"
        ),
    },
    "ca_AstroPh": {
        "dep_list": [tasks_decompress["ca_AstroPh"]],
        "command": remove_file_header_command.format(
            n="2", tmp_dir="/tmp/snap/ca_AstroPh/", file_name="ca_AstroPh"
        ),
    },
    "amazon0312": {
        "dep_list": [tasks_decompress["amazon0312"]],
        "command": remove_file_header_command.format(
            n="2", tmp_dir="/tmp/snap/amazon0312/", file_name="amazon0312"
        ),
    },
    "sentinel": {
        "dep_list": [tasks_decompress["sentinel"]],
        "command": remove_file_header_command.format(
            n="2", tmp_dir="/tmp/sentinel2", file_name="sentinel-2-metadata-table"
        ),
    },
}
for (t, params) in params_remove_file_header.items():
    tasks_remove_file_header[t] = ShellTask(
        command=params_remove_file_header["command"]
    )
...
params_convert_csv_to_orc = {
    "ca_GrQc": {
        "dep_list": [tasks_remove_file_header["ca_GrQc"]],
        "command": convert_csv_to_orc_command.format(
    ...
    "web_Stanford": {
        "dep_list": [tasks_remove_file_header["web_Stanford"]],
        "command": convert_csv_to_orc_command.format(
            schema="from_id:BIGINT,to_id:BIGINT",
            table_name="web_Stanford",
            tmp_dir="/tmp/snap/web_Stanford/",
    ...
    "ca_HepTh": {
        "dep_list": [tasks_remove_file_header["ca_HepTh"]],
        "command": convert_csv_to_orc_command.format(
            schema="from_id:BIGINT,to_id:BIGINT",
            table_name="ca_HepTh",
            tmp_dir="/tmp/snap/ca_HepTh/",
    ...
    "ca_HepPh": {
        "dep_list": [tasks_remove_file_header["ca_HepPh"]],
        "command": convert_csv_to_orc_command.format(
            schema="from_id:BIGINT,to_id:BIGINT",
            table_name="ca_HepPh",
            tmp_dir="/tmp/snap/ca_HepPh/",
    ...
    "amazon0505": {
        "dep_list": [tasks_remove_file_header["amazon0505"]],
        "command": convert_csv_to_orc_command.format(
            schema="from_id:BIGINT,to_id:BIGINT",
            table_name="amazon0505",
            tmp_dir="/tmp/snap/amazon0505/",
    ...
    "sentinel": {
        "dep_list": [tasks_remove_file_header["sentinel"]],
        "command": convert_csv_to_orc_command.format(
            schema=(
    ...
    "web_NotreDame": {
        "dep_list": [tasks_remove_file_header["web_NotreDame"]],
        "command": convert_csv_to_orc_command.format(
            schema="from_id:BIGINT,to_id:BIGINT",
            table_name="web_NotreDame",
            tmp_dir="/tmp/snap/web_NotreDame/",
    ...
    "amazon0302": {
        "dep_list": [tasks_remove_file_header["amazon0302"]],
        "command": convert_csv_to_orc_command.format(
            schema="from_id:BIGINT,to_id:BIGINT",
            table_name="amazon0302",
            tmp_dir="/tmp/snap/amazon0302/",
    ...
    "amazon0601": {
        "dep_list": [tasks_remove_file_header["amazon0601"]],
        "command": convert_csv_to_orc_command.format(
            schema="from_id:BIGINT,to_id:BIGINT",
            table_name="amazon0601",
            tmp_dir="/tmp/snap/amazon0601/",
    ...
    "amazon0312": {
        "dep_list": [tasks_remove_file_header["amazon0312"]],
        "command": convert_csv_to_orc_command.format(
            schema="from_id:BIGINT,to_id:BIGINT",
            table_name="amazon0312",
            tmp_dir="/tmp/snap/amazon0312/",
    ...
    "ca_CondMat": {
        "dep_list": [tasks_remove_file_header["ca_CondMat"]],
        "command": convert_csv_to_orc_command.format(
            schema="from_id:BIGINT,to_id:BIGINT",
            table_name="ca_CondMat",
            tmp_dir="/tmp/snap/ca_CondMat/",
    ...
    "web_Google": {
        "dep_list": [tasks_remove_file_header["web_Google"]],
        "command": convert_csv_to_orc_command.format(
            schema="from_id:BIGINT,to_id:BIGINT",
            table_name="web_Google",
            tmp_dir="/tmp/snap/web_Google/",
    ...
    "web_BerkStan": {
        "dep_list": [tasks_remove_file_header["web_BerkStan"]],
        "command": convert_csv_to_orc_command.format(
            schema="from_id:BIGINT,to_id:BIGINT",
            table_name="web_BerkStan",
            tmp_dir="/tmp/snap/web_BerkStan/",
    ...
    "ca_AstroPh": {
        "dep_list": [tasks_remove_file_header["ca_AstroPh"]],
        "command": convert_csv_to_orc_command.format(
            schema="from_id:BIGINT,to_id:BIGINT",
            table_name="ca_AstroPh",
            tmp_dir="/tmp/snap/ca_AstroPh/",
...
for (t, params) in params_convert_csv_to_orc.items():
    tasks_convert_csv_to_orc[t] = ShellTask(
        command=params_convert_csv_to_orc["command"]
    )
...
params_is_audited_table = {
    "ca_AstroPh": {
        "dep_list": [replicated_data_sets__sentinel, replicated_data_sets__snap]
    },
    "web_Stanford": {
        "dep_list": [replicated_data_sets__sentinel, replicated_data_sets__snap]
    },
