...
'"""
params_hive_schemas_created = {'amazon0601': {'dep_list': [],
...
params_replicated_schema = {'ca_HepTh': {'dep_list': [tasks_hive_schemas_created['ca_HepTh']]},
...
params_download_data_from_remote_web_location = {'web_NotreDame': {'dep_list': [],
'command': 'curl {address} -O {tmp_dir}/{file_name}'.format(tmp_dir='/tmp/snap/web_NotreDame/', address='https://snap.stanford.edu/data/web-NotreDame.txt.gz', file_name='web_NotreDame')},
'amazon0302': {'dep_list': [],
'command': 'curl {address} -O {tmp_dir}/{file_name}'.format(tmp_dir='/tmp/snap/amazon0302/', address='https://snap.stanford.edu/data/amazon0302.txt.gz', file_name='amazon0302')},
'ca_AstroPh': {'dep_list': [],
'command': 'curl {address} -O {tmp_dir}/{file_name}'.format(tmp_dir='/tmp/snap/ca_AstroPh/', address='https://snap.stanford.edu/data/ca-AstroPh.txt.gz', file_name='ca_AstroPh')},
'ca_CondMat': {'dep_list': [],
'command': 'curl {address} -O {tmp_dir}/{file_name}'.format(tmp_dir='/tmp/snap/ca_CondMat/', address='https://snap.stanford.edu/data/ca-CondMat.txt.gz', file_name='ca_CondMat')},
'ca_HepPh': {'dep_list': [],
'command': 'curl {address} -O {tmp_dir}/{file_name}'.format(tmp_dir='/tmp/snap/ca_HepPh/', address='https://snap.stanford.edu/data/ca-HepPh.txt.gz', file_name='ca_HepPh')},
'web_BerkStan': {'dep_list': [],
'command': 'curl {address} -O {tmp_dir}/{file_name}'.format(tmp_dir='/tmp/snap/web_BerkStan/', address='https://snap.stanford.edu/data/web-BerkStan.txt.gz', file_name='web_BerkStan')},
'amazon0312': {'dep_list': [],
'command': 'curl {address} -O {tmp_dir}/{file_name}'.format(tmp_dir='/tmp/snap/amazon0312/', address='https://snap.stanford.edu/data/amazon0312.txt.gz', file_name='amazon0312')},
'ca_GrQc': {'dep_list': [],
'command': 'curl {address} -O {tmp_dir}/{file_name}'.format(tmp_dir='/tmp/snap/ca_GrQc/', address='https://snap.stanford.edu/data/ca-GrQc.txt.gz', file_name='ca_GrQc')},
'ca_HepTh': {'dep_list': [],
'command': 'curl {address} -O {tmp_dir}/{file_name}'.format(tmp_dir='/tmp/snap/ca_HepTh/', address='https://snap.stanford.edu/data/ca-HepTh.txt.gz', file_name='ca_HepTh')},
'amazon0505': {'dep_list': [],
'command': 'curl {address} -O {tmp_dir}/{file_name}'.format(tmp_dir='/tmp/snap/amazon0505/', address='https://snap.stanford.edu/data/amazon0505.txt.gz', file_name='amazon0505')},
'web_Google': {'dep_list': [],
'command': 'curl {address} -O {tmp_dir}/{file_name}'.format(tmp_dir='/tmp/snap/web_Google/', address='https://snap.stanford.edu/data/web-Google.txt.gz', file_name='web_Google')},
'web_Stanford': {'dep_list': [],
'command': 'curl {address} -O {tmp_dir}/{file_name}'.format(tmp_dir='/tmp/snap/web_Stanford/', address='https://snap.stanford.edu/data/web-Stanford.txt.gz', file_name='web_Stanford')},
'amazon0601': {'dep_list': [],
'command': 'curl {address} -O {tmp_dir}/{file_name}'.format(tmp_dir='/tmp/snap/amazon0601/', address='https://snap.stanford.edu/data/amazon0601.txt.gz', file_name='amazon0601')}}
...
"""
params_remove_file_header = {'ca_CondMat': {'dep_list': [tasks_decompress['ca_CondMat']],
'command': remove_file_header_command.format(n='2', tmp_dir='/tmp/snap/ca_CondMat/', file_name='ca_CondMat')},
'amazon0302': {'dep_list': [tasks_decompress['amazon0302']],
'command': remove_file_header_command.format(n='2', tmp_dir='/tmp/snap/amazon0302/', file_name='amazon0302')},
'amazon0312': {'dep_list': [tasks_decompress['amazon0312']],
'command': remove_file_header_command.format(n='2', tmp_dir='/tmp/snap/amazon0312/', file_name='amazon0312')},
'ca_AstroPh': {'dep_list': [tasks_decompress['ca_AstroPh']],
'command': remove_file_header_command.format(n='2', tmp_dir='/tmp/snap/ca_AstroPh/', file_name='ca_AstroPh')},
'amazon0505': {'dep_list': [tasks_decompress['amazon0505']],
'command': remove_file_header_command.format(n='2', tmp_dir='/tmp/snap/amazon0505/', file_name='amazon0505')},
'ca_HepTh': {'dep_list': [tasks_decompress['ca_HepTh']],
'command': remove_file_header_command.format(n='2', tmp_dir='/tmp/snap/ca_HepTh/', file_name='ca_HepTh')},
'amazon0601': {'dep_list': [tasks_decompress['amazon0601']],
'command': remove_file_header_command.format(n='2', tmp_dir='/tmp/snap/amazon0601/', file_name='amazon0601')},
'ca_GrQc': {'dep_list': [tasks_decompress['ca_GrQc']],
'command': remove_file_header_command.format(n='2', tmp_dir='/tmp/snap/ca_GrQc/', file_name='ca_GrQc')},
'web_Stanford': {'dep_list': [tasks_decompress['web_Stanford']],
'command': remove_file_header_command.format(n='2', tmp_dir='/tmp/snap/web_Stanford/', file_name='web_Stanford')},
'web_NotreDame': {'dep_list': [tasks_decompress['web_NotreDame']],
'command': remove_file_header_command.format(n='2', tmp_dir='/tmp/snap/web_NotreDame/', file_name='web_NotreDame')},
'sentinel': {'dep_list': [tasks_decompress['sentinel']],
'command': remove_file_header_command.format(n='2', tmp_dir='/tmp/sentinel2', file_name='sentinel-2-metadata-table')},
'web_Google': {'dep_list': [tasks_decompress['web_Google']],
'command': remove_file_header_command.format(n='2', tmp_dir='/tmp/snap/web_Google/', file_name='web_Google')},
'web_BerkStan': {'dep_list': [tasks_decompress['web_BerkStan']],
'command': remove_file_header_command.format(n='2', tmp_dir='/tmp/snap/web_BerkStan/', file_name='web_BerkStan')},
'ca_HepPh': {'dep_list': [tasks_decompress['ca_HepPh']],
'command': remove_file_header_command.format(n='2', tmp_dir='/tmp/snap/ca_HepPh/', file_name='ca_HepPh')}}
...
"""
params_convert_csv_to_orc = {'web_Google': {'dep_list': [tasks_remove_file_header['web_Google']],
'command': convert_csv_to_orc_command.format(schema='from_id:BIGINT,to_id:BIGINT', tmp_dir='/tmp/snap/web_Google/', table_name='web_Google')},
'amazon0601': {'dep_list': [tasks_remove_file_header['amazon0601']],
'command': convert_csv_to_orc_command.format(schema='from_id:BIGINT,to_id:BIGINT', tmp_dir='/tmp/snap/amazon0601/', table_name='amazon0601')},
'web_BerkStan': {'dep_list': [tasks_remove_file_header['web_BerkStan']],
'command': convert_csv_to_orc_command.format(schema='from_id:BIGINT,to_id:BIGINT', tmp_dir='/tmp/snap/web_BerkStan/', table_name='web_BerkStan')},
'amazon0302': {'dep_list': [tasks_remove_file_header['amazon0302']],
'command': convert_csv_to_orc_command.format(schema='from_id:BIGINT,to_id:BIGINT', tmp_dir='/tmp/snap/amazon0302/', table_name='amazon0302')},
'ca_HepTh': {'dep_list': [tasks_remove_file_header['ca_HepTh']],
'command': convert_csv_to_orc_command.format(schema='from_id:BIGINT,to_id:BIGINT', tmp_dir='/tmp/snap/ca_HepTh/', table_name='ca_HepTh')},
'web_Stanford': {'dep_list': [tasks_remove_file_header['web_Stanford']],
'command': convert_csv_to_orc_command.format(schema='from_id:BIGINT,to_id:BIGINT', tmp_dir='/tmp/snap/web_Stanford/', table_name='web_Stanford')},
'amazon0312': {'dep_list': [tasks_remove_file_header['amazon0312']],
'command': convert_csv_to_orc_command.format(schema='from_id:BIGINT,to_id:BIGINT', tmp_dir='/tmp/snap/amazon0312/', table_name='amazon0312')},
'ca_GrQc': {'dep_list': [tasks_remove_file_header['ca_GrQc']],
'command': convert_csv_to_orc_command.format(schema='from_id:BIGINT,to_id:BIGINT', tmp_dir='/tmp/snap/ca_GrQc/', table_name='ca_GrQc')},
'ca_AstroPh': {'dep_list': [tasks_remove_file_header['ca_AstroPh']],
'command': convert_csv_to_orc_command.format(schema='from_id:BIGINT,to_id:BIGINT', tmp_dir='/tmp/snap/ca_AstroPh/', table_name='ca_AstroPh')},
'ca_CondMat': {'dep_list': [tasks_remove_file_header['ca_CondMat']],
'command': convert_csv_to_orc_command.format(schema='from_id:BIGINT,to_id:BIGINT', tmp_dir='/tmp/snap/ca_CondMat/', table_name='ca_CondMat')},
'sentinel': {'dep_list': [tasks_remove_file_header['sentinel']],
'command': convert_csv_to_orc_command.format(schema=('granule_id:STRING,product_id:STRING'
...
',east_lon:FLOAT,base_url:STRING'), tmp_dir='/tmp/sentinel2', table_name='sentinel-2-metadata-table')},
'web_NotreDame': {'dep_list': [tasks_remove_file_header['web_NotreDame']],
'command': convert_csv_to_orc_command.format(schema='from_id:BIGINT,to_id:BIGINT', tmp_dir='/tmp/snap/web_NotreDame/', table_name='web_NotreDame')},
'ca_HepPh': {'dep_list': [tasks_remove_file_header['ca_HepPh']],
'command': convert_csv_to_orc_command.format(schema='from_id:BIGINT,to_id:BIGINT', tmp_dir='/tmp/snap/ca_HepPh/', table_name='ca_HepPh')},
'amazon0505': {'dep_list': [tasks_remove_file_header['amazon0505']],
'command': convert_csv_to_orc_command.format(schema='from_id:BIGINT,to_id:BIGINT', tmp_dir='/tmp/snap/amazon0505/', table_name='amazon0505')}}
...
params_upload_data_to_local = {'web_BerkStan': {'dep_list': [tasks_convert_csv_to_orc['web_BerkStan']]},
...
params_replicated_assets = {'amazon0505': {'dep_list': [tasks_replicated_schema['amazon0505'], tasks_file_ready_for_upload['amazon0505'], tasks_upload_data_to_local['amazon0505']]},
...
'web_Google': {'dep_list': [tasks_replicated_schema['web_Google'], tasks_file_ready_for_upload['web_Google'], tasks_upload_data_to_local['web_Google']]},
...
for dep in [tasks_replicated_assets['amazon0312'], tasks_replicated_assets['ca_HepPh'], tasks_replicated_assets['ca_GrQc'], tasks_replicated_assets['web_Google'], tasks_replicated_assets['ca_CondMat'], tasks_replicated_assets['amazon0302'], tasks_replicated_assets['web_BerkStan'], tasks_replicated_assets['ca_HepTh'], tasks_replicated_assets['amazon0601'], tasks_replicated_assets['ca_AstroPh'], tasks_replicated_assets['amazon0505'], tasks_replicated_assets['web_Stanford'], tasks_replicated_assets['web_NotreDame']]:
...
params_is_audited_table = {'ca_AstroPh': {'dep_list': [replicated_data_sets__sentinel, replicated_data_sets__snap]},
...
'amazon0302': {'dep_list': [replicated_data_sets__sentinel, replicated_data_sets__snap]},
...
for dep in [tasks_is_audited_table['ca_GrQc'], tasks_is_audited_table['ca_CondMat'], tasks_is_audited_table['amazon0601'], tasks_is_audited_table['web_Google'], tasks_is_audited_table['amazon0312'], tasks_is_audited_table['web_Stanford'], tasks_is_audited_table['web_NotreDame'], tasks_is_audited_table['ca_HepTh'], tasks_is_audited_table['ca_AstroPh'], tasks_is_audited_table['ca_HepPh'], tasks_is_audited_table['web_BerkStan'], tasks_is_audited_table['sentinel'], tasks_is_audited_table['amazon0302'], tasks_is_audited_table['amazon0505']]:
